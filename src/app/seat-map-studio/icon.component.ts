...
export class IconComponent {
  ...
  private static readonly P: Record<string, string> = {
    ...
    TableLong: '<rect x="5" y="9.5" width="14" height="5" rx="1.6"/><circle cx="8" cy="5.4" r="1.6" fill="currentColor" stroke="none"/><circle cx="12" cy="5.4" r="1.6" fill="currentColor" stroke="none"/><circle cx="16" cy="5.4" r="1.6" fill="currentColor" stroke="none"/><circle cx="8" cy="18.6" r="1.6" fill="currentColor" stroke="none"/><circle cx="12" cy="18.6" r="1.6" fill="currentColor" stroke="none"/><circle cx="16" cy="18.6" r="1.6" fill="currentColor" stroke="none"/>',
